import { SonifierLibrary, SonifierRegistration, Sonifier, SonifierDescriptor } from './index.js';

class MockSynth implements Sonifier {
...
function testRegisterMany() {
  ...
  const synths: SonifierRegistration[] = [
  ...
  // Test overwrite
  const overwrite: SonifierRegistration[] = [
